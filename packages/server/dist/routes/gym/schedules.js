...
import { getScheduleTemplates, getScheduleTemplateById, createScheduleTemplate, updateScheduleTemplate, deleteScheduleTemplate, } from '../../controllers/scheduleTemplates.js';
import { getActiveSchedules, getActiveScheduleById, createActiveSchedule, deleteActiveSchedule, resetActiveSchedule, assignStaff, unassignStaff, } from '../../controllers/activeSchedules.js';
import { getAvailableSchedules, getMySchedule, joinTimeslot, leaveTimeslot, } from '../../controllers/clientSchedules.js';
...
router.get('/templates', verifyToken, requireRole([UserType.ADMIN, UserType.OWNER, UserType.COACH]), getScheduleTemplates);
...
router.get('/templates/:id', verifyToken, requireRole([UserType.ADMIN, UserType.OWNER, UserType.COACH]), getScheduleTemplateById);
// POST /api/gym/schedules/templates - Create new schedule template
// Admin/Owner only
router.post('/templates', verifyToken, requireRole([UserType.ADMIN, UserType.OWNER]), createScheduleTemplate);
// PUT /api/gym/schedules/templates/:id - Update schedule template
// Admin/Owner only
router.put('/templates/:id', verifyToken, requireRole([UserType.ADMIN, UserType.OWNER]), updateScheduleTemplate);
// DELETE /api/gym/schedules/templates/:id - Delete schedule template
// Admin/Owner only
router.delete('/templates/:id', verifyToken, requireRole([UserType.ADMIN, UserType.OWNER]), deleteScheduleTemplate);
...
router.get('/active', verifyToken, requireRole([UserType.ADMIN, UserType.OWNER, UserType.COACH, UserType.CLIENT]), getActiveSchedules);
...
router.get('/active/:id', verifyToken, requireRole([UserType.ADMIN, UserType.OWNER, UserType.COACH, UserType.CLIENT]), getActiveScheduleById);
// POST /api/gym/schedules/active - Create active schedule from template
// Admin/Owner only
router.post('/active', verifyToken, requireRole([UserType.ADMIN, UserType.OWNER]), createActiveSchedule);
// DELETE /api/gym/schedules/active/:id - Delete active schedule
// Admin/Owner only
router.delete('/active/:id', verifyToken, requireRole([UserType.ADMIN, UserType.OWNER]), deleteActiveSchedule);
// POST /api/gym/schedules/active/:id/reset - Reset active schedule from template
// Admin/Owner only
router.post('/active/:id/reset', verifyToken, requireRole([UserType.ADMIN, UserType.OWNER]), resetActiveSchedule);
// ===== Staff Assignment Routes =====
// POST /api/gym/schedules/active/:id/assign - Assign coach to active schedule
// Admin/Owner only
router.post('/active/:id/assign', verifyToken, requireRole([UserType.ADMIN, UserType.OWNER]), assignStaff);
// DELETE /api/gym/schedules/active/:id/unassign/:coachId - Unassign coach from active schedule
// Admin/Owner only
router.delete('/active/:id/unassign/:coachId', verifyToken, requireRole([UserType.ADMIN, UserType.OWNER]), unassignStaff);
