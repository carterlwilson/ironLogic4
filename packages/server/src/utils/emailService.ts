...
/**
 * Send a welcome email to a newly imported client, directing them to set their own password
 */
export const sendWelcomeEmail = async (
  ...
  const msg = {
    to: email,
    from: verifiedSender,
    subject: 'Welcome to Cully Strength — set your password',
    text: `Hi ${firstName},\n\nYour account has been created on the Cully Strength app. To get started, click the link below to set your own password:\n\n${resetLink}\n\nThis link will expire in 7 days.\n\nIf you have any questions, reach out to your coach.\n\nBest regards,\nCully Strength`,
    html: `
      <!DOCTYPE html>
      <html>
        <head>
        ...
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
          <div style="background-color: #f8f9fa; border-radius: 8px; padding: 30px; margin-bottom: 20px;">
            ...
            <p style="font-size: 16px; margin-bottom: 20px;">Hi ${firstName},</p>
            <p style="font-size: 16px; margin-bottom: 20px;">
              Your account has been created on the Cully Strength app. Click the button below to set your own password and log in for the first time.
            </p>
            <div style="text-align: center; margin: 30px 0;">
              <a href="${resetLink}" style="background-color: #228be6; color: white; padding: 14px 28px; text-decoration: none; border-radius: 6px; display: inline-block; font-weight: bold; font-size: 16px;">
                Set My Password
